                ...
                <tr>
                    <td style="padding:32px;">
                        ...
                        <div style="margin-top:24px;">
                            <a href="{{ $portalUrl }}" style="display:inline-block;background:#0D7377;color:#ffffff;text-decoration:none;border-radius:6px;padding:12px 18px;font-size:14px;font-weight:700;">
                                Open secure patient dashboard
                            </a>
                        </div>
                        <p style="margin:12px 0 0;color:#6b7280;font-size:13px;line-height:1.5;">
                            This secure link is for you. If you did not request it, you can ignore this email.
                        </p>
                    </td>
                </tr>
            </table>
